    ...
    def generate_response(self, user_id: str, message: str, context: str = "") -> str:
        try:
            ...
            if response_strategy["type"] == "direct_answer":
                ...
                return self._generate_conversational_response(user_id, message, context, gathered_info) # Pass user_id
...
🏟️ אולימפיאדת הקיץ השלישית בלוס אנג’לס"""
    ...
    def _generate_conversational_response(self, user_id: str, message: str, context: str, info: dict) -> str:
