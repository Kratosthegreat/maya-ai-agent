 ...
 "ENCOUNTER_PACK": [
  {
   ...
   "choices": [
    {
     "label": "לשמוע מה יש לו להציע",
     "hint": "פותח את שוק הסוכנים",
    ...
    {
     "label": "לקחת את הכרטיס ולא להתקשר",
     "hint": "בלי התחייבות",
  ...
  {
   "eid": "e_hotel_director",
   "title": "אותו מלון, אותו בוקר",
   "stages": [
    "player"
   ],
   "weight": 3.0,
  ...
  {
   "eid": "e_national_call",
   "title": "מאמן הנבחרת בשורה השנייה",
   "stages": [
    "player"
   ],
   "weight": 2.6,
   ...
   "choices": [
    ...
    {
     "label": "לשאול מה צריך כדי להיכנס",
     "hint": "יעד ברור",
  ...
  {
   "eid": "e_partner_abroad",
   "title": "גם לה יש קריירה",
   "stages": [
    "player",
    "veteran"
   ],
  ...
  },
  {
   ...
   "choices": [
    {
     "label": "להגיד בדיוק מה אתה עושה הכי טוב",
     "hint": "ברור",
  ...
  {
   "eid": "e_wonderkid_hype",
   "title": "\"הכי טוב שיצא מכאן\"",
   "stages": [
    "academy",
    "player"
   ],
  ...
  {
   "eid": "e_release_clause",
   "title": "מישהו שילם את הסעיף",
   "stages": [
    "player"
   ],
   "weight": 1.8,
