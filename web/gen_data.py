...
from football_manager import encounter_pack as EP  # noqa: E402
...
SOURCES = [
    ...
    ("AGENT_NAMES", D),
    ("CLUB_COUNTRY", D), ("STAT_LINES", D), ("STAT_LABELS", D),
    ("DIRECTIVE_REASON", D), ("MILESTONE_REWARD", D),
    ("TECHNICAL", D), ("MENTAL", D), ("PHYSICAL", D), ("GOALKEEPING", D),
    ("MIN_DETAIL", D), ("MAX_DETAIL", D),
    ("COUNTRY_FLAGS", D), ("LEAGUES", D),
    ("ATTR_GROUPS", D), ("DETAIL_NAMES_HE", D), ("DETAIL_GROUP", D),
    ("OUTFIELD_ATTRS", D), ("KEEPER_ATTRS", D),
    ("GROUP_MAP", D), ("GROUP_MAP_GK", D),
    ("HIDDEN_ATTRS", D), ("PERSONALITIES", D), ("PERSONALITY_EFFECT", D),
    ("ROLES", D), ("DUTY_NAMES_HE", D), ("DUTY_SHIFT", D),
    ("TEAM_INSTRUCTIONS", D), ("INSTRUCTION_KEYS", D), ("TACTICAL_STYLES", D),
    ("ATTR_INFO", D), ("FOCUS_INFO", D),
    ("DETAIL_DECLINE", P),
    ("ASSETS", D), ("ASSET_EVENTS", D), ("BONUS_CLAUSES", D),
...
def main() -> None:
    ...
    out["ENCOUNTER_PACK"] = out.pop("ENCOUNTERS")
