...
## ⚽ בונוס: משחק ניהול כדורגל

במאגר נמצא גם **קריירה** — משחק טקסט עצמאי בעברית בסגנון מנג'ר, שבו
מפתחים שחקן מגיל 16 ועד הפרישה, וממשיכים לקריירה שאחריה (מאמן, מנג'ר,
...
ומותאם לטלפון, עם סמלי מועדונים, מגרש עם ההרכב וגרפים — הכל מחולל ב-SVG.
